...
class StatelessEx6Page extends StatelessWidget {
  const StatelessEx6Page({super.key});
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            print(
                'Boton apretado'); //al apretar imprime 'Boton apretado' en consola
          },
