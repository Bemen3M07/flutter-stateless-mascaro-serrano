...
class StatefulEx6Page extends StatefulWidget {
  const StatefulEx6Page({super.key});

  @override
  State<StatefulEx6Page> createState() => _StatefulEx6PageState();
}
...
class _StatefulEx6PageState extends State<StatefulEx6Page> {
  @override
